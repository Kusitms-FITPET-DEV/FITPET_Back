...
public final class PetConstants {
    public static final int NO_MATCHING_RESULT_COUNT = 0;
    public static final String NO_MATCHING_RESULT_ALTERNATIVE = "믹스견";
    public static final int NO_MIN_OR_MAX_INSURANCE_FEE = -1;

    public static final String PETPERMINT = "petpermint";
    public static final String SAMSUNG = "samsung";
    public static final String DB = "db";
    public static final String HYUNDAI = "hyundai";
    public static final String KB = "kb";

    public static final String PRICE_RATE = "70%";
